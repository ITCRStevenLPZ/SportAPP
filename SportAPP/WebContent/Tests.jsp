...
<div id="navbar">
  ...
  <div id="navbar-right">
    ...
    <a class="active" href="Tests.jsp">Pruebas Fisicas</a>
    <a class="logout" href="/logout">Cerrar Sesion</a>
  </div>
  <div id="navbar-initial">
  	<a class="active" href="Tests.jsp">Acerca de las Pruebas</a>
  	<a href="Cooper.jsp">Consultar Pesos</a>
  	<a href=".jsp">Modificar y Eliminar Pesos</a>
  </div>
</div>

<div style="margin-top:210px;padding:15px 15px 2500px;font-size:30px">
  <p><b>¡Bienvenido(a) a Acerca de las Pruebas!</b></p>
</div>
<script>
