...
<head>
<meta charset="UTF-8">
<title>Modificacion de Pruebas Cooper</title>
  ...
  <div id="navbar-initial">
	...
	<form accept-charset="ISO-8859-1" action="cooper" autocomplete="off"
		...
		<fieldset>
			...
			<label for="distancia"><b>Distancia a modificar</b></label><br /> <input name="distancia" type="text" value="${cooper.getDistancia()}" required/> <br/> 
			
			<label for="edad"><b>Edad a modificar</b></label><br /> <input name="edad" type="text" required/> <br />
			
			<input type="hidden" name  = "ID" value = "${cooper.getID()}">	
