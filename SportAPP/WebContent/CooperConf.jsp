...
<head>
<meta charset="UTF-8">
<title>Cambiar Datos de Cooper</title>
...
<form accept-charset="ISO-8859-1" action="confCooper" autocomplete="off"
	...
	<form accept-charset="ISO-8859-1" action="confCooper" method="post" class="container">
		<fieldset>
			<h1>¡Consulta los Datos de Cooper!</h1>
			<input type="submit"  name="accion" value = "Consultar Datos Cooper" class = "btn"></input> <br />
		</fieldset>	
	<div>
		<table>
			<tr>
		...
		<tbody>
			<c:forEach var="dato" items = "${dataCoopers}">
				<tr> 
					<td>${dato.getEdad()}</td>
					<td>${dato.getMalo()}</td>
					<td>${dato.getMedio()}</td>
					...
					<td>
						<form action="confCooper" method="post">
