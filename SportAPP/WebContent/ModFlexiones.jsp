...
<head>
<meta charset="UTF-8">
<title>Modificacion de Pruebas de Flexiones</title>
  ...
  <div id="navbar-initial">
	...
	<form accept-charset="ISO-8859-1" action="flexiones" autocomplete="off"
		...
		<fieldset>
			...
			<label for="cantidad"><b>Cantidad de flexiones a modificar</b></label><br /> <input name="cantidad" type="text" value="${flexion.getFlexiones()}" required/> <br/> 
			
			<label for="edad"><b>Edad a modificar</b></label><br /> <input name="edad" type="text" required/> <br />
			
			<input type="hidden" name  = "ID" value = "${flexion.getID()}">	
