...
<div id="navbar">
  ...
  <div id="navbar-initial">
  	...
  	<a class="active" href="Cooper.jsp">Prueba de Cooper</a>
  	<a href="Flexiones.jsp">Prueba de Flexiones</a>
  </div>
</div>
<form accept-charset="ISO-8859-1" action="cooper" autocomplete="off"
		...
		<fieldset>
			...
			<label for="distancia"><b>Distancia</b></label><br /> <input placeholder="Ingresar Distancia" name="distancia" type="text" /> <br required/> 
			
			<label for="edad"><b>Edad</b></label><br /> <input placeholder="Ingresar Edad" name="edad" type="text" /> <br required/> 

			<input type="submit"  name="accion" value = "¡Ingresar Prueba Cooper!" class = "btn"></input> 
		</fieldset>	
</form>

	<form accept-charset="ISO-8859-1" action="cooper" method="post" class="container">
		<fieldset>
			<h1>¡Consulta tus Pruebas de Cooper!</h1>
	...
	<div>
		...
		<tbody>
			<c:forEach var="dato" items = "${coopers}">
				<tr> 
					<td>${dato.getDistancia()}</td>
					<td>${dato.getFecha()}</td>
					<td>${dato.getResultado()}</td>
					<td>
						<form action="cooper" method="post">
