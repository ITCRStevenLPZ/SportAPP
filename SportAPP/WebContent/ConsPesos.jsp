...
<div id="navbar">
  ...
  <div id="navbar-initial">
  	...
  	<a class="active" href="ConsPesos.jsp">Consultar Pesos y Gestionarlos</a>
  </div>
</div>

	<form accept-charset="ISO-8859-1" action="selPesos" method="post" class="container">
		<fieldset>
			<h1>¡Consulta tus Pesos!</h1>
			<input type="submit"  name="accion" value = "¡Consultar Pesos!" class = "btn"></input> <br />
		</fieldset>	
	<div>
		<table>
			<tr>
		...
		<tbody>
			<c:forEach var="dato" items = "${pesos}">
				<tr> 
					<td>${dato.getPeso()}</td>
					<td>${dato.getFecha()}</td>
					<td>${dato.getDescripcion()}</td>
					<td>
						<form action="selPesos" method="post">
